...
log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-gold.GUI")

class TrainerGUI(ctk.CTk):
    def __init__(self, trainer: Trainer):
        super().__init__()
        self.trainer = trainer
        self.title("Destiny2-Ultimate-Trainer-2026-gold 2.0.0")
    ...
    def create_widgets(self):
        ctk.CTkLabel(self, text="Destiny2-Ultimate-Trainer-2026-gold", font=("Segoe UI", 24, "bold")).pack(pady=20)
...
def create_tray_icon(gui):
    ...
    return pystray.Icon("trainer", img, "Destiny2-Ultimate-Trainer-2026-gold", menu)
