...
log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-gold.WebDashboard")

class WebDashboard:
    def __init__(self, trainer: Trainer, port=4203):
...
<html>
<head>
    <title>Destiny2-Ultimate-Trainer-2026-gold Dashboard</title>
    <style>
...
<body>
    <h1>Destiny2-Ultimate-Trainer-2026-gold</h1>
    <div id="features"></div>
    <script>
